...
- **Pre-release health check:** Before every `/release`, run a repo-wide health check (stale branches, outdated docs, dangling references; prune the issue ledger) and report only the conclusions to the user.

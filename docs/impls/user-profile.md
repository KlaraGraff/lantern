...
- 不动 `followup_difficulty.rs`(上游只读)、`harness/`、`scripts/*.mjs`、`src-tauri/src/mcp/control.rs`(该文件从未进 `main`;分支已于 2026-08-11 删除,代码归档在 tag `archive/mcp-control-bridge-wip`;这条纪律因此已自动满足)。

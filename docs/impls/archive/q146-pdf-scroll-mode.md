...
**Spec:** `docs/features/archive/q146-pdf-scroll-mode.md`
...
See the user-facing checklist in `docs/features/archive/q146-pdf-scroll-mode.md`. Add these code-level checks:

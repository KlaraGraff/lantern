...
- [mcp-tool-selection-corpus.json](../testing/mcp-tool-selection-corpus.json)
- [mcp-tool-selection-README.md](../testing/mcp-tool-selection-README.md)
...
The untracked [control.rs](../../src-tauri/src/mcp/control.rs) is a backend foundation for MCP control of live app and reader windows. It is **not feature complete**.

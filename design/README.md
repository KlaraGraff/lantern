...
Conventions:
- `lantern-desktop.pen` is the canonical design source for the Tauri desktop app. Split into per-surface files (e.g. `reader.pen`, `library.pen`) only if `lantern-desktop.pen` gets unwieldy.

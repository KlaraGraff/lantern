...
<!-- 样张占位：AI 侧栏的回答范围选择器、阅读思考保护开关、答案下方的进度提示
...
<!-- 样张占位：「这本书对你」——覆盖率标尺 + 词次构成 + 哪些词认下来提升最大
...
于是你可以做出面向雅思的**长难句拆解**、用于文学的**修辞与叙事视角**、用于专业书的**术语与前置知识**，或者只保留最少信息的**极简查词**。
...
<!-- 样张占位：MCP 设置页与 Claude Code 终端并排

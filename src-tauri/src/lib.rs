...
pub fn run() {
    ...
    let app = install_menu(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::coverage::list_shelf_coverage,
            commands::coverage::preview_vocab_profile_clear,
            ...
            // migration's header comment for the sync note).
            commands::reading_behavior::record_reading_behavior_batch,
            commands::reading_behavior::list_word_exposures,
            ...
            commands::ai::ai_stop_book_index,
            commands::ai::ai_books_needing_index,
            commands::ai::ai_index_all_books,
            commands::ai::ai_stop_index_all_books,
            commands::ai::ai_index_all_books_status,
            ...
            commands::ai::list_person_aliases,
            commands::ai::build_person_aliases,
            commands::ai::add_person_alias,
            commands::ai::teach_description_alias,
            commands::ai::delete_person_alias,
            commands::ai::clear_person_aliases,
            // Settings
            ...
            commands::settings::undo_promote_book_settings,
            ...
            commands::dictionary_glance::record_dictionary_glance,
            ...
            commands::ai::ai_request_counts_summary,
            // OAuth
            ...
            // Quiz-scroll (词卷) papers + wrong-word repetition pool
            commands::quiz::create_quiz_paper,
            commands::quiz::get_quiz_paper,
            commands::quiz::list_quiz_papers,
            commands::quiz::update_quiz_paper_content,
            ...
            commands::quiz::clear_wrong_words,

...
export default function ReaderExportDialog({ open, bookId, bookTitle, onClose, resolveChapter }: ReaderExportDialogProps) {
  ...
  return <div className="motion-scrim fixed inset-0 z-50 flex items-center justify-center bg-black/35 p-4" onKeyDown={onDialogKeyDown} onPointerDown={(event) => { if (event.currentTarget === event.target && status !== "saving") onClose(); }}>

...
const wordModules = (language: FixtureLanguage): Partial<Record<LearningModuleId, LearningModuleContent>> =>
  language === "zh" ? {
    ...
    grammar_role: content("在句中作动词原形。", ["它跟在情态动词 must 之后，宾语是 the tone。"]),
    ...
    grammar_role: content("The base form of the verb here.", ["It follows the modal must and takes the tone as its object."]),
